...
master_graph = nx.union_all([G[0],G[2]])


print(nx.is_connected(master_graph.to_undirected()))
...
#for sub_graph in nx.weakly_connected_components(master_graph):
#    if len(sub_graph) == 10000:
#        connected_subgraph = master_graph.subgraph(sub_graph)
#        break
